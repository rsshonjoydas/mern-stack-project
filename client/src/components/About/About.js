    ...
    <div className="max-width">
      ...
      <div className="about-content">
        ...
        <div className="column right">
          <div className="text">
            I am Prakash and I am a <span className="typing-2" />
          </div>
          <p>
            ...
            exercitationem consequuntur blanditiis omnis beatae. Dolor iste excepturi ratione soluta
            quas culpa voluptatum repudiandae harum non.
          </p>
